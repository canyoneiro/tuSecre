...
import { IonicPage, PopoverController, NavParams, ViewController, NavController } from 'ionic-angular';
...
export class CalendarPage implements OnInit {
  ...
  presentMonthModal() {
    let monthModal = this.popCtrl.create(MonthPopover);
    monthModal.present();
...
export class MonthPopover {
  ...
  close(month) {
    this.viewCtrl.dismiss(moment().month(month));
  }
}
